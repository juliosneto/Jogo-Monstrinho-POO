...
public class Monstrinho {
	...
	public void eventoDois() {
		System.out.println("Seu monstrinho foi o milésimo cliente a entrar numa loja!");
	...
	public void eventoTres() {
		System.out.println("Seu monstrinho foi ao estádio assistir ao jogo mas, seu time perdeu!");
